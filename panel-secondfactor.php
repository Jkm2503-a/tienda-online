<?php
  ...
  if ($user['two_factor_key'] === null) {
      ...
      $qrCode = \Sonata\GoogleAuthenticator\GoogleQrUrl::generate($user['name'], $secret, "Shop Now");
  } 
 // (link) var_dump($qrCode);
...
<body>
            ...
            <div class="row">
                <div class="col-md-4">
                    <form id="activate-second-factor">                   
                        ...
                        <button type="submit" class="btn btn-primary btn-dark">Activar doble factor</button>
                    </form>              
    ...
    <?php else: ?>
        <div class="container mt-5">        
            ...
            <button type="button" class="btn btn-primary btn-dark" id="deactivate-second-factor">Desactivar doble factor</button>
        </div>
    <?php endif; ?>
