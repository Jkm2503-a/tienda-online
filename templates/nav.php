  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <ul class="navbar-nav ml-auto">
      <?php if ($userController->isUserLoggedIn()): ?>
        ...
        <li class="nav-item active">
          <a class="nav-link" href="productos/index.php"><?= $_SESSION['email'] ?> <span class="sr-only"></span></a>
        </li>
        <li class="nav-item active">
      ...
      <?php else: ?>
        <li class="nav-item active">
          <a class="nav-link" href="register.php">Registro <span class="sr-only"></span></a>
        </li>
        <li class="nav-item active">
