      ...
      <div class="container">
        ...
        <div id="navbar" class="navbar-collapse collapse">
          <ul class="nav navbar-nav pull-right">
            <li class="active">
              <a href="index.php" class="nav-link">Pedidos</a>
            </li> 
            <li>
          ...
          <div class="col-md-12">
            <fieldset>
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                    <label>cedula</label>
                    <input value="<?php print $info_pedido['cedula'] ?>" type="num" class="form-control" readonly>
                </div>
                <div class="form-group">
                    <label>Email</label>
            ...
            <div class="pull-right">
                <a href="index.php" id="btnImprimir" class="btn btn-default">OK</a>
            </div>      
          </div>
        </div>
    </div> <!-- /container -->
